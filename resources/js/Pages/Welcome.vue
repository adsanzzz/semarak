                ...
                >
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden">
                        ...
                        <div class="p-4 text-left">
                            <div
                                class="flex items-center text-yellow-500 text-sm mb-1"
                            >
                                ⭐
                            ...
                            <span
                                class="inline-block bg-gray-100 text-gray-700 text-xs px-2 py-1 mt-2 rounded"
                                >FOOD</span
                            >
                            <div class="mt-2">
                            ...
                            <button
                                class="w-full mt-4 bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-medium py-2 rounded-md flex items-center justify-center"
                            >
                                Tambah ke Keranjang
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                >
                                    <path
                                        ...
                                        stroke-linejoin="round"
                                        stroke-width="2"
                                        d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.5 7h13M7 13L5.4 5"
                                    />
                                </svg>
                            </button>
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden">
                        ...
                        <div class="p-4 text-left">
                            ...
                            <h3 class="font-semibold text-gray-900">Tofu</h3>
                            <p class="text-sm text-gray-500">
                                Toko Bu Alin • 1.4 KM
                            </p>
                            <span
